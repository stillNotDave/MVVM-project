package ru.sfedu.simplemvvm.model.colors

import ru.sfedu.simplemvvm.model.Repository

// Именно этот интерфейс нужно указывать в конструкторах ВьюМоделей, которые хотел работать с этим репозиторием
