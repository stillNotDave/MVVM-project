...
import ru.sfedu.simplemvvm.ARG_SCREEN
import ru.sfedu.simplemvvm.App
import ru.sfedu.simplemvvm.MainViewModel
...
// Этот класс - фабрика, позволяющая создавать ВьюМодели
